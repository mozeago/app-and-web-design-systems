...
5. Text sized using 18-point or a bold 14-point only needs a contrast of 3 to 1.
6. Text that doesn’t appear in an active part of the web page doesn’t need to abide by this rule.
7. The contrast of text within a logo can be set at the designer’s discretion.
